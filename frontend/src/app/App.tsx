...
const ChatPage = lazy(() =>
  import("../features/conversations/ChatPage").then((module) => ({
...
const GroupSettingsPage = lazy(() =>
  import("../features/conversations/GroupSettingsPage").then((module) => ({
    default: module.GroupSettingsPage,
  })),
);
const NewConversationPage = lazy(() =>
  import("../features/conversations/NewConversationPage").then((module) => ({
    default: module.NewConversationPage,
  })),
);
...
const ResourcesPage = lazy(() =>
  import("../features/marketing/MarketingPages").then((module) => ({
...
export function App() {
  return (
    <Suspense
      fallback={
        <AsyncState kind="loading" description="Preparando o Gloopy." />
      }
    >
      <Routes>
        ...
        <Route element={<Protected />}>
          ...
          <Route
            path="/conversations/:id/settings"
          ...
          <Route
            ...
            element={
              <PlaceholderPage
                title="Seus jogos"
                description="Os convites e partidas aparecem dentro de cada conversa para manter todo mundo no mesmo ritmo."
              />
            }
          />
